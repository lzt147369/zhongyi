layui.use(['layer','form','table','laytpl'], function() {
    ...
    t = {
        ...
        cols: [[
            {type:'checkbox'},
            {field:'loginName', title: '手机号码',align: 'center', width:'10%'},
            {field:'nickName',  title: '昵称',   align: 'center', width:'10%'},
            {field:'email',     title: '邮箱',   align: 'center', width:'16%' },
            {field:'locked',    title: '状态',align: 'center',width:'8%',templet:'#userStatus'},
            {field:'createDate',  title: '创建时间',align: 'center',width:'14%'}, //单元格内容水平居中
